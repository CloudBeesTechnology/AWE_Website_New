...
export default function TimeSheetUpdateForm(props) {
  const {
    id: idProp,
    timeSheet: timeSheetModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    ...
    setAssignBy(cleanValues.assignBy);
    setEmpName(cleanValues.empName);
    setEmpBadgeNo(cleanValues.empBadgeNo);
    setEmpID(cleanValues.empID);
    setEmpDept(cleanValues.empDept);
    setInTime(cleanValues.inTime);
    setOutTime(cleanValues.outTime);
    setTotalInOut(cleanValues.totalInOut);
    setAllDayHrs(cleanValues.allDayHrs);
    setTotalHrs(cleanValues.totalHrs);
    setRemarks(cleanValues.remarks);
    setOtTime(cleanValues.otTime);
    setNetMins(cleanValues.netMins);
    setActualWorkHrs(cleanValues.actualWorkHrs);
    setNormalWorkHrs(cleanValues.normalWorkHrs);
    setFidNo(cleanValues.fidNo);
    setCompanyName(cleanValues.companyName);
    setTrade(cleanValues.trade);
    setTradeCode(cleanValues.tradeCode);
    setOnAM(cleanValues.onAM);
    setOffAM(cleanValues.offAM);
    setOnPM(cleanValues.onPM);
    setOffPM(cleanValues.offPM);
    setCtr(cleanValues.ctr);
    setRec(cleanValues.rec);
    setAvgDailyTD(cleanValues.avgDailyTD);
    setHighlightDayTG(cleanValues.highlightDayTG);
    setAweSDN(cleanValues.aweSDN);
    setTotalNT(cleanValues.totalNT);
    setTotalOT(cleanValues.totalOT);
    ...
    setMealAllow(cleanValues.mealAllow);
    setVerify(cleanValues.verify);
    setBpCompany(cleanValues.bpCompany);
    setEarliestEntryTime(cleanValues.earliestEntryTime);
    setLatestEntryTime(cleanValues.latestEntryTime);
    setErrors({});
  };
  const [timeSheetRecord, setTimeSheetRecord] =
    React.useState(timeSheetModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? (
            await client.graphql({
              query: getTimeSheet.replaceAll("__typename", ""),
              variables: { id: idProp },
            })
          )?.data?.getTimeSheet
        : timeSheetModelProp;
    ...
    queryData();
  }, [idProp, timeSheetModelProp]);
  React.useEffect(resetStateValues, [timeSheetRecord]);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        let modelFields = {
          ...
          totalInOut: totalInOut ?? null,
          allDayHrs: allDayHrs ?? null,
          totalHrs: totalHrs ?? null,
          remarks: remarks ?? null,
          otTime: otTime ?? null,
          netMins: netMins ?? null,
          actualWorkHrs: actualWorkHrs ?? null,
          normalWorkHrs: normalWorkHrs ?? null,
          fidNo: fidNo ?? null,
          ...
          ctr: ctr ?? null,
          rec: rec ?? null,
          avgDailyTD: avgDailyTD ?? null,
          highlightDayTG: highlightDayTG ?? null,
          aweSDN: aweSDN ?? null,
          totalNT: totalNT ?? null,
          ...
          mealAllow: mealAllow ?? null,
          verify: verify ?? null,
          bpCompany: bpCompany ?? null,
          earliestEntryTime: earliestEntryTime ?? null,
          latestEntryTime: latestEntryTime ?? null,
        };
        ...
        try {
          ...
          await client.graphql({
            query: updateTimeSheet.replaceAll("__typename", ""),
            variables: {
              input: {
      ...
      {...getOverrideProps(overrides, "TimeSheetUpdateForm")}
      {...rest}
    >
      <TextField
        label="Date"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || timeSheetModelProp)}
