...
import { createHeadOffice } from "../graphql/mutations";
...
export default function HeadOfficeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createHeadOffice.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "HeadOfficeCreateForm")}
      {...rest}
    >
      <ArrayField
