...
import { createORMCSheet } from "../graphql/mutations";
...
export default function ORMCSheetCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createORMCSheet.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "ORMCSheetCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
