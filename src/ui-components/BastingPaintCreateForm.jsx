...
export default function BastingPaintCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBlastingRemarks(initialValues.blastingRemarks);
    setBlastingEndDate(initialValues.blastingEndDate);
    setBlastingStartDate(initialValues.blastingStartDate);
    setBlastingBadgeNo(initialValues.blastingBadgeNo);
    setBlastingQulifiExp(initialValues.blastingQulifiExp);
    setBlastingUpload(initialValues.blastingUpload);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBastingPaint.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BastingPaintCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
