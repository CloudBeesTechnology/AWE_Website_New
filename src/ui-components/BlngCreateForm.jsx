...
import { createBlng } from "../graphql/mutations";
...
export default function BlngCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setWeeklySheet(initialValues.weeklySheet);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBlng.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BlngCreateForm")}
      {...rest}
    >
      <ArrayField
