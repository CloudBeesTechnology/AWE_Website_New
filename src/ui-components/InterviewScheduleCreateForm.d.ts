...
export declare type InterviewScheduleCreateFormInputValues = {
    interDate?: string;
    interTime?: string;
    venue?: string;
    interType?: string;
...
export declare type InterviewScheduleCreateFormOverridesProps = {
    InterviewScheduleCreateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type InterviewScheduleCreateFormProps = React.PropsWithChildren<{
    ...
    onSubmit?: (fields: InterviewScheduleCreateFormInputValues) => InterviewScheduleCreateFormInputValues;
    onSuccess?: (fields: InterviewScheduleCreateFormInputValues) => void;
    onError?: (fields: InterviewScheduleCreateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: InterviewScheduleCreateFormInputValues) => InterviewScheduleCreateFormInputValues;
    onValidate?: InterviewScheduleCreateFormValidationValues;
} & React.CSSProperties>;
export default function InterviewScheduleCreateForm(props: InterviewScheduleCreateFormProps): React.ReactElement;
