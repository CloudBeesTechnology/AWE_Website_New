...
export default function IDDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setApplicationUpload(initialValues.applicationUpload);
    setCurrentApplicationUploadValue("");
    setBwnIcNo(initialValues.bwnIcNo);
    setBwnIcColour(initialValues.bwnIcColour);
    setBwnIcExpiry(initialValues.bwnIcExpiry);
    setCurrentBwnIcExpiryValue("");
    setBwnUpload(initialValues.bwnUpload);
    setCurrentBwnUploadValue("");
    setCvCertifyUpload(initialValues.cvCertifyUpload);
    setCurrentCvCertifyUploadValue("");
    setDriveLic(initialValues.driveLic);
    setInducBrief(initialValues.inducBrief);
    setInducBriefUp(initialValues.inducBriefUp);
    setLoiUpload(initialValues.loiUpload);
    setCurrentLoiUploadValue("");
    setMyIcNo(initialValues.myIcNo);
    setMyIcUpload(initialValues.myIcUpload);
    setCurrentMyIcUploadValue("");
    setNationality(initialValues.nationality);
    setNationalCat(initialValues.nationalCat);
    setOtherNation(initialValues.otherNation);
    setOtherRace(initialValues.otherRace);
    setOtherReligion(initialValues.otherReligion);
    setPpNo(initialValues.ppNo);
    setCurrentPpNoValue("");
    setPaafCvevUpload(initialValues.paafCvevUpload);
    setCurrentPaafCvevUploadValue("");
    setPpIssued(initialValues.ppIssued);
    setCurrentPpIssuedValue("");
    setPpExpiry(initialValues.ppExpiry);
    setCurrentPpExpiryValue("");
    setPpUpload(initialValues.ppUpload);
    setCurrentPpUploadValue("");
    setPpDestinate(initialValues.ppDestinate);
    setCurrentPpDestinateValue("");
    setPreEmp(initialValues.preEmp);
    setPreEmpPeriod(initialValues.preEmpPeriod);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createIDDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "IDDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
