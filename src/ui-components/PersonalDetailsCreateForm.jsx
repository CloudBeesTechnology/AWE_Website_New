...
import { createPersonalDetails } from "../graphql/mutations";
...
export default function PersonalDetailsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPersonalDetails.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PersonalDetailsCreateForm")}
      {...rest}
    >
      <TextField
        label="Temp id"
