...
export declare type PersonalDetailsUpdateFormInputValues = {
    tempID?: string;
    age?: number;
    alternateNo?: string;
    agent?: string;
...
export declare type PersonalDetailsUpdateFormOverridesProps = {
    PersonalDetailsUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type PersonalDetailsUpdateFormProps = React.PropsWithChildren<{
    ...
    id?: string;
    personalDetails?: any;
    onSubmit?: (fields: PersonalDetailsUpdateFormInputValues) => PersonalDetailsUpdateFormInputValues;
    onSuccess?: (fields: PersonalDetailsUpdateFormInputValues) => void;
    onError?: (fields: PersonalDetailsUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: PersonalDetailsUpdateFormInputValues) => PersonalDetailsUpdateFormInputValues;
    onValidate?: PersonalDetailsUpdateFormValidationValues;
} & React.CSSProperties>;
export default function PersonalDetailsUpdateForm(props: PersonalDetailsUpdateFormProps): React.ReactElement;
