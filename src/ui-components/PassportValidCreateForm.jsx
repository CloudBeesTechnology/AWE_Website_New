...
export default function PassportValidCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setPpLocation(initialValues.ppLocation);
    setCurrentPpLocationValue("");
    setArrivStampUpload(initialValues.arrivStampUpload);
    setCurrentArrivStampUploadValue("");
    setImmigEmpUpload(initialValues.immigEmpUpload);
    setCurrentImmigEmpUploadValue("");
    setReEntryUpload(initialValues.reEntryUpload);
    setCurrentReEntryUploadValue("");
    setArrivStampExp(initialValues.arrivStampExp);
    setCurrentArrivStampExpValue("");
    setImmigRefNo(initialValues.immigRefNo);
    setPpSubmit(initialValues.ppSubmit);
    setCurrentPpSubmitValue("");
    setEmpPassExp(initialValues.empPassExp);
    setCurrentEmpPassExpValue("");
    setEmpPassStatus(initialValues.empPassStatus);
    setCurrentEmpPassStatusValue("");
    setAirTktStatus(initialValues.airTktStatus);
    setCurrentAirTktStatusValue("");
    setReEntryVisa(initialValues.reEntryVisa);
    setCurrentReEntryVisaValue("");
    setImmigApproval(initialValues.immigApproval);
    setCurrentImmigApprovalValue("");
    setReEntryVisaExp(initialValues.reEntryVisaExp);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createPassportValid.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "PassportValidCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
