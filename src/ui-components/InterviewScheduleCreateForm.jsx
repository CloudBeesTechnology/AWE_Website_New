...
export default function InterviewScheduleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBagdeNo(initialValues.bagdeNo);
    setMessage(initialValues.message);
    setTempID(initialValues.tempID);
    setManager(initialValues.manager);
    setCandidateStatus(initialValues.candidateStatus);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createInterviewSchedule.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "InterviewScheduleCreateForm")}
      {...rest}
    >
      <TextField
        label="Inter date"
