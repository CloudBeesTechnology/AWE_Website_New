...
export default function InsuranceTypeCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setTypeIns(initialValues.typeIns);
    setInsDetails(initialValues.insDetails);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createInsuranceType.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "InsuranceTypeCreateForm")}
      {...rest}
    >
      <TextField
        label="Type ins"
