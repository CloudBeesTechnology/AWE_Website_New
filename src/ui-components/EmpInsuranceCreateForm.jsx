...
export default function EmpInsuranceCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setGroupIns(initialValues.groupIns);
    setCurrentGroupInsValue("");
    setGroupInsEffectDate(initialValues.groupInsEffectDate);
    setCurrentGroupInsEffectDateValue("");
    setGroupInsEndDate(initialValues.groupInsEndDate);
    setCurrentGroupInsEndDateValue("");
    setEmpStatusType(initialValues.empStatusType);
    setWorkmenCompNo(initialValues.workmenCompNo);
    setTravelIns(initialValues.travelIns);
    setCurrentTravelInsValue("");
    setAccidentIns(initialValues.accidentIns);
    setCurrentAccidentInsValue("");
    setEmpInsUpload(initialValues.empInsUpload);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createEmpInsurance.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "EmpInsuranceCreateForm")}
      {...rest}
    >
      <TextField
        label="Emp id"
